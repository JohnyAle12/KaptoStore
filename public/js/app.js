...
window._ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js"); //require('datatables.net-bs4');
...
$(document).on("click", ".approve-user", function () {
  ...
  $.ajax({
    ...
    beforeSend: function beforeSend(data) {//$(".contentBtnApprove"+id).html('<div class="loader"></div>');
    },
    success: function success(data) {
      toastr.success(data['message'], "Notificación:");
...
__webpack_require__(/*! /Users/johnyalejandro/Desktop/Kapto Store/KaptoStore/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/johnyalejandro/Desktop/Kapto Store/KaptoStore/resources/sass/app.scss */"./resources/sass/app.scss");
